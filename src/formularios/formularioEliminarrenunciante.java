...
public class formularioEliminarrenunciante extends JFrame{
  ...
  public static void main(String[] args)
  {
       ...
       EventQueue.invokeLater(new Runnable()
       {
           public void run()
           {
        	   ...
        	   formularioEliminarrenunciante form=new formularioEliminarrenunciante();
  ...
  public formularioEliminarrenunciante()
  {
	  try {
        ...
        for(int i=0;i<table.getRowCount();i++)
        {
          ...
          if(checked)
          {
        	  int confirmado = JOptionPane.showConfirmDialog(
        			  null, "Va a eliminar el donante con coddonante: "+col+". ¿Está seguro?", 
        			  "Advertencia", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
        	  			
        			if (JOptionPane.OK_OPTION == confirmado) {
        				renunciantes renunciante = new renunciantes();
        				Controllerrenunciantes controller = new Controllerrenunciantes();
        				int setcodrenunciante;
        				controller.eliminar(renunciante);
